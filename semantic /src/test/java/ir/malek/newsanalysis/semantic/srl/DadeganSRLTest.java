...
import ir.malek.newsanalysis.semantic.classification.PronounClassifier;
...
public class DadeganSRLTest {
	...
	public static void main(String[] args) {
		...
		String dadeganFilePath = ".." + File.separator +".." + File.separator + "input" + File.separator+ "semantic"+ File.separator + "dadeganWithNounClass6.txt";
